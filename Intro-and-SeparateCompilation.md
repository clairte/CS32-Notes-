...
#### Example: Stick Figures 
        ...
        {
            public: 
                StickFigure(double body1, double hd, string nm, double head, double heady);
            private: 
                string m_name; 
                Circle m_head; 
                double m_bodyLength; 
        ...
        StickFigure:: StickFigure(double body1, double hd, string nm, double headx, double head y)
        {
            ...
            m_y = y; 
            m_r = r;
            THIS DOES NOT COMPILE: the data members are private to Circle 
            */ 
        }
...
- Use initializer list 
    ...
    - **Performance**: string `m_name` is a class type
...
- you declare a container (e.g. an array/vector) of objects of that class tuype 
